...
struct DiscoveryLanguage {
    ...
    private static func translatedWhat(_ value: String) -> String {
        let whatMap: [String: String] = [
            ...
            "fabric": "weefsel",
            "timing": "timing",
            "setup-violation": "setup-schending",
            "hold-violation": "hold-schending",
            "setup-timing": "setup-observatie",
            "hold-timing": "hold-observatie",
            "max-fanout": "te hoge fanout",
            "max-transition": "te trage overgang",
            "max-capacitance": "te hoge capacitantie",
            "power": "vermogen",
            "static-power": "statisch verbruik",
            "dynamic-power": "dynamisch verbruik",
            "ir-drop": "spanningsval",
            "electromigration": "metaaldegradatie",
            "area": "oppervlak",
            "cell-area": "celoppervlak",
            "routing-congestion": "routeringscongestie",
            "density-violation": "dichtheidsschending",
            "thermal": "thermisch",
            "hotspot": "oververhitting",
            "thermal-gradient": "temperatuurgradiënt",
            "reliability": "betrouwbaarheid",
            "oxide-breakdown": "oxide-doorbraak",
            "nbti-degradation": "verouderingsdrift",
            "antenna-violation": "antenne-schending",
            "chip-timing": "chip timing",
            "chip-power": "chip vermogen",
            "chip-reliability": "chip betrouwbaarheid"
        ]
